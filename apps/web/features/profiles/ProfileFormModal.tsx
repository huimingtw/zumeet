...
function LocationField({
  ...
  setLocPickerOpen: (v: boolean) => void;
}) {
  return (
    <div>
...
export function ProfileFormModal({
  ...
  return (
    <Modal
      open
      onClose={onClose}
      labelledBy="profile-form-title"
      className="flex flex-col !overflow-hidden"
    >
      <div className="flex flex-shrink-0 items-center justify-between border-b border-gray-100 px-6 py-4">
        <h3 id="profile-form-title" className="text-base font-semibold text-gray-950">
      ...
      >
        <div className="no-scrollbar flex-1 space-y-4 overflow-y-auto px-6 py-4">
          ...
          <BudgetChips setValue={setValue} budgetMin={budgetMin} budgetMax={budgetMax} />
          ...
          <LocationField
            ...
            setLocPickerOpen={setLocPickerOpen}
          />
